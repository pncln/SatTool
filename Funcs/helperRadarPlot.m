classdef helperRadarPlot
    ...
    methods
        ...
        function updateRadarPlots(obj,targets ,dets)
            ...
            for j=1: numel(dets)
                for i=1:numel(dets(j))
                    currentDet = dets(j);
                    meas = currentDet{i}.Measurement;
